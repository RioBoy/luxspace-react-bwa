...
export default function ShippingDetails() {
  return (
    <div class="w-full md:px-4 lg:w-4/12" id="shipping-detail">
          ...
          <div class="flex flex-col mb-4">
            ...
            <div class="flex -mx-2 flex-wrap">
              <div class="px-2 w-6/12 h-24 mb-4">
                ...
                >
                  <img
                    src="/images/content/logo-fedex.png"
                    alt="Logo Fedex"
              ...
              <div class="px-2 w-6/12 h-24 mb-4">
                ...
                >
                  <img
                    src="/images/content/logo-dhl.png"
                    alt="Logo dhl"
                    class="object-contain max-h-full"
                  />
                </button>
          ...
          <div class="flex flex-col mb-4">
            ...
            <div class="flex -mx-2 flex-wrap">
              ...
              <div class="px-2 w-6/12 h-24 mb-4">
                ...
                >
                  <img
                    src="/images/content/logo-mastercard.png"
                    alt="Logo mastercard"
                  />
                </button>
              </div>
              <div class="px-2 w-6/12 h-24 mb-4">
                ...
                >
                  <img
                    src="/images/content/logo-bitcoin.png"
                    alt="Logo bitcoin"
                    class="object-contain max-h-full"
                  />
                </button>
              ...
              <div class="px-2 w-6/12 h-24 mb-4">
                ...
                >
                  <img
                    src="/images/content/logo-american-express.png"
